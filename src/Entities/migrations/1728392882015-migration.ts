  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      CREATE TABLE \`monthly_salary\` (
        ...
        \`unitOvertimePayment\` decimal(9,2) NOT NULL,
        \`overtimePayment\` decimal(9,2) NOT NULL,
        \`bonus\` decimal(9,2) NOT NULL,
        \`leaveEncashment\` decimal(9,2) NOT NULL,
        \`late\` int NOT NULL,
        \`unitLateDeduction\` decimal(9,2) NOT NULL,
        \`lateDeduction\` decimal(9,2) NOT NULL,
        \`penalty\` decimal(9,2) NOT NULL,
        \`leave\` decimal(9,2) NOT NULL,
        \`absence\` decimal(3,1) NOT NULL,
        \`unitAbsenceDeduction\` decimal(9,2) NOT NULL,
        \`leaveDeduction\` decimal(9,2) NOT NULL,
        \`absenceDeduction\` decimal(9,2) NOT NULL,
